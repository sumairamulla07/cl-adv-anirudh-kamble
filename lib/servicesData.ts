...
export const services: ServiceDetail[] = [
  ...
  },
  {
    ...
    documents: [
      { name: "Memorandum of Understanding (MOU)", desc: "An MOU lays the foundation for future transactions. We draft clear and structured MOUs that capture the intent, expectations, and preliminary commitments of all parties. This helps prevent misunderstandings, builds trust, and creates a strong framework before entering into legally binding agreements." },
      { name: "Agreement to Sale", desc: "The foundation of every property transaction. This document records the full understanding between buyer and seller—covering price, payment structure, timelines, and key conditions. We draft Agreements that secure your advance payment, eliminate ambiguity, and protect you from last-minute changes or disputes, ensuring a smooth path to final ownership." },
      { name: "Sale Deed", desc: "The most critical ownership document—this is what legally transfers the property into your name. A poorly drafted Sale Deed can create serious legal complications years later. We ensure precise title verification, correct stamp duty calculation, accurate property description, and full legal compliance, so your ownership is clear, valid, and future-proof." },
      { name: "Gift Deed", desc: "Transferring property to family members requires more than just intent—it must be legally structured. We handle end-to-end drafting, stamp duty guidance (including concessional benefits), and registration, ensuring the transfer is legally valid, tax-aware, and dispute-free." },
      { name: "Lease Deed", desc: "For long-term rental arrangements, a properly drafted Lease Deed is essential. We create agreements that clearly define rent terms, lock-in periods, maintenance responsibilities, renewal clauses, and exit conditions—protecting both parties and preventing future disagreements." },
      { name: "Leave & License Agreement", desc: "The most preferred rental structure in Maharashtra due to its flexibility and legal clarity. We draft agreements that safeguard the property owner’s rights while maintaining compliance with local laws, and handle complete online registration through the government iSarita system, making the process seamless and hassle-free." },
      { name: "Power of Attorney", desc: "When you cannot be physically present, a properly drafted POA becomes critical. We prepare clear, tightly defined General and Special POAs that grant only the required authority—minimising risk of misuse while ensuring smooth execution of your property matters, especially for NRIs and senior citizens." },
