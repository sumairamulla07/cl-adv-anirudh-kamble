...
export const metadata: Metadata = {
  ...
  description: "Protect your property rights with Pune's leading property lawyer. Advocate Anirudh Kamble offers 24+ years of practice in property documentation, title verification, sale deed drafting, and RERA compliance. Call 9922836682.",
          ...
          >
            ...
            <AnimatedSection delay={0.15}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.7rem, 3vw, 2.6rem)", fontWeight: 300, color: INK, lineHeight: 1.1, marginBottom: "1rem" }}>
                Comprehensive Legal Assistance<br />in Property Law
              </h2>
